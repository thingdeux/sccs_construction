...
class Quote(models.Model):
    ...
    last_name = models.CharField("Last Name", max_length=254, default="",
                                 db_index=True)
    phone = models.CharField("Phone", max_length=30, null=True, blank=True)
    date_requested = models.DateTimeField("Date Quote Requested",
